page 50088 "Workflow SharePoint API"
{
    PageType = API;
    APIPublisher = 'cnette';
    APIGroup = 'demo';
    APIVersion = 'v2.0';
    EntityCaption = 'workflowSharePoint';
    EntitySetCaption = 'workflowSharePoint';
    EntityName = 'workflowSharePoint';
    EntitySetName = 'workflowSharePoint';
    ChangeTrackingAllowed = true;
    DelayedInsert = true;
    ODataKeyFields = SystemId;
    SourceTable = "Workflow SharePoint";
    Extensible = false;
