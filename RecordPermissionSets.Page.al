page 50049 "Record Permission Sets"
{
    ApplicationArea = All;
    Caption = 'Aufzeichnung - Berechtigungssätze (Automatisch)';
    ...
    var
        ...
        TextBox: Label 'Solange die Seite geöffnet ist werden alle Berechtigungen aufgezeichnet. Wenn diese Seite geschlossen wird, dann erfolgt eine automatische Speicherung der Berechtigungen';
}