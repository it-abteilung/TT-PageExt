page 50106 "Employee Card History API"
{
    PageType = API;
    APIPublisher = 'cnette';
    APIGroup = 'demo';
    APIVersion = 'v2.0';
    EntityCaption = 'EmployeeCardHistory';
    EntitySetCaption = 'EmployeeCardHistory';
    EntityName = 'employeecardhistory';
    EntitySetName = 'employeecardhistory';
    ...
    trigger OnOpenPage()
    begin
        Rec.SetFilter("Id Expires On", '<>%1', 0D);
    end;
