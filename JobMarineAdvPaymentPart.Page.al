page 50205 JobMarineAdvPaymentPart
{
    Caption = 'Projekte - Vorkasse';
    PageType = ListPart;
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    SourceTable = Job;
    SourceTableView = SORTING("No.") ORDER(descending) WHERE(Status = filter(Vorkasse), "Job Type" = filter('20000' | '40000'));
